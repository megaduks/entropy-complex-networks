...
class Network(object):
    ...
    Args:
        load_strategy:
            use load.load_graph_inverted_weight_no_negative in case e.g. pagerank because it may not converge with negative distances
            otherwise you can use load.load_graph_inverted_weight. To pass function with more args use e.g. "partial" module
        alg:
        ...
        weight_strategy:
            weight_strategy, you can pass diffrent like pagerank, betweeness etc.
